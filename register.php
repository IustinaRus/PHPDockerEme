    ...
    <body id="page-top">
        ...
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                <h1 class="mb-1">Adopt me</h1>
                <h3 class="mb-5"><em>make a new best friend</em></h3>
                <a class="btn btn-primary btn-xl" href="#about">Login/Or make an account</a>
            </div>
        </header>
        <!-- About-->
...
<button type="submit"><a href="index.php">Create account</a></button>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-4 gx-lg-5">
                    <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
                        ...
                        <h4><strong>CUTE DOGS</strong></h4>
                        <p class="text-faded mb-0">because all the dogs are cute!</p>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
                        <span class="service-icon rounded-circle mx-auto mb-3"><i class="icon-pencil"></i></span>
                        <h4><strong>ENERGIC DOGS</strong></h4>
                        <p class="text-faded mb-0">they will keep you in shape</p>
                    </div>
